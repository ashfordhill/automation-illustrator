 ...
 * Merge-group render ids live only on the projection, not here.
 */
import type { EdgeDto, MergeGroupDto, NodeDto, WorkflowDoc } from "./types";
...
export function findMergeGroup(doc: WorkflowDoc, id: string): MergeGroupDto | undefined {
