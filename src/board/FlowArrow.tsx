/**
 * Orthogonal flow arrow between tiles.
 * Stroke is edge.dashed, or exclusive-split fallback (pathGeometry.edgeIsDotted).
 * During − pick, matching edges flash (.edge-pick / .edge-pick-on in tokens.css).
 */
import { BaseEdge, EdgeLabelRenderer, type EdgeProps } from "@xyflow/react";
import { useStore } from "../state/store";
import { edgeIsDotted, outgoingSorted } from "./pathGeometry";
