 ...
 * (no painted-out white scribbles on the legs).
 *
...
export function PresentButton() {
  ...
  return (
    <Tooltip label="Present (Escape to leave)">
      ...
      >
        <svg viewBox="0 0 56 50" width="52" height="46" aria-hidden>
          <rect className="present-box" x="2" y="4" width="50" height="28" rx="7" />
          {/* Flip so the figure faces the board from the top-right; stand in front of the slide. */}
          <g className="present-figure" transform="translate(54 10) scale(-0.76 0.76)">
            <path className="present-leg-knockout" d="M12.5 34v11" />
