 ...
 * Theme and keybind keys live here so persist concerns stay in one folder.
 */
import { ActorKind, AssignmentLane, ColorScheme, WORKFLOW_VERSION } from "../model/catalogs";
import { DEFAULT_HUMAN_ROLE, emptyWorkflow, type ActorDto, type WorkflowDoc } from "../model/types";
