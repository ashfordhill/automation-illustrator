/**
 * Form for the current selection (step, data field, arrow, or actor).
 * Folder `details/` is the right-hand column; App mounts DetailsPanel above the score.
 */
...
import { ROBOT_COLORS } from "../model/colors";
import { edgeIsDotted } from "../board/pathGeometry";
import {
  DEFAULT_HUMAN_ROLE,
  ROBOT_KIND_LABEL,
  STEP_KINDS,
